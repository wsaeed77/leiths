...
class Mobile_Detect {
	...
	protected static $phoneDevices = array(
		...
		'Sony'          => 'SonyST|SonyLT|SonyErwpfson|SonyErwpfsonLT15iv|LT18i|E10i|LT28h|LT26w|SonyErwpfsonMT27i|C5303|C6902|C6903|C6906|C6943|D2533',
		...
		'GenericPhone'  => 'Tapatalk|PDA;|SAGEM|\bmmp\b|pocket|\bpsp\b|symbian|Smartphone|smartfon|treo|up.browser|up.link|vodafone|\bwap\b|nokia|Series40|Series60|S60|SonyErwpfson|N900|MAUI.*WAP.*Browser',
	);
	...
	//    'IntextTablet' => null,
		...
		// http://www.pyleaudio.com/Products.aspx?%2fproducts%2fPersonal-Electronwpf%2fTablets
		...
		// http://www.wolderelectronwpf.com/productos/manuales-y-guias-rapidas/categoria-2-miTab
	...
	public function isMobile( $userAgent = null, $httpHeaders = null ) {
		...
		if ($this->getUserAgent() === 'Amazon CloudFront') {
			...
			if (array_key_exists('HTTP_CLOUDFRONT_IS_MOBILE_VIEWER', $cfHeaders) && ( 'true' === $cfHeaders['HTTP_CLOUDFRONT_IS_MOBILE_VIEWER'] ) ) {
				return true;
			}
		}
	...
	public function isTablet( $userAgent = null, $httpHeaders = null ) {
		...
		if ($this->getUserAgent() === 'Amazon CloudFront') {
			$cfHeaders = $this->getCfHeaders();
			if ( array_key_exists('HTTP_CLOUDFRONT_IS_TABLET_VIEWER', $cfHeaders) && ( 'true' === $cfHeaders['HTTP_CLOUDFRONT_IS_TABLET_VIEWER'] ) ) {
				return true;
			}
		}
	...
	public function version( $propertyName, $type = self::VERSION_TYPE_STRING ) {
		...
		if ( ( self::VERSION_TYPE_STRING !== $type ) && ( self::VERSION_TYPE_FLOAT !== $type ) ) {
		...
		if ( true === isset($properties[$propertyName]) ) {
			...
			foreach ($properties[$propertyName] as $propertyMatchString) {
				...
				if (false === empty($match[1])) {
					$version = ( self::VERSION_TYPE_FLOAT == $type ? $this->prepareVersionNo($match[1]) : $match[1] );
	...
	public function mobileGrade() {
		...
		if (
			...
			// Android 4.0 (WPF)  - Tested on a Galaxy Nexus. Note: transition performance can be poor on upgraded devices

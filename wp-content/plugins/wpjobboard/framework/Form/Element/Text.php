...
class Daq_Form_Element_Text extends Daq_Form_Element implements Daq_Form_Element_Interface
{
    ...
    public function dump()
    {
        ...
        $data->validation_year_range = $this->getMeta("validation_year_range");
    ...
    public function overload(array $data) 
    {
        ...
        if( isset($data["validation_year_range"]) && ! empty($data["validation_year_range"])) {
            $this->addMeta("validation_year_range", $data["validation_year_range"]);
        }
    ...
    public function render() 
    {
        ...
        if($this->getMeta("validation_year_range")) {
            $options["data-year-range"] = $this->getMeta("validation_year_range");
        }

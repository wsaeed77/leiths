...
class Wpjb_Utility_Taxer 
{
    ...
    public function setFromPricing($pricing) {
        ...
        $this->setTaxRate( apply_filters( "wpjb_taxer_tax_rate", wpjb_conf("taxes_default_rate"), $pricing ) );
        $this->setType( apply_filters( "wpjb_taxer_type", wpjb_conf("taxes_price_type"), $pricing ) );
        $this->setEnabled( apply_filters( "wpjb_taxer_enabled", $enabled, $pricing ) );

        $this->setPrice( apply_filters( "wpjb_taxer_price", $pricing->getPrice(), $pricing ) );
        $this->setDiscount( apply_filters( "wpjb_taxer_discount", $pricing->getDiscount(), $pricing ) );
    }

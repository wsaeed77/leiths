...
class Wpjb_Utility_Assets {
    ...
    public function registerScriptsCommon() {
        ...
        wp_register_script("wpjb-vendor-selectlist", $x."select-list/jquery.selectlist.pack.js", array("jquery"), $v, true);
        ...
        wp_register_script("wpjb-vendor-datepicker", $x."date-picker-v2/js/datepicker.js", array( "jquery", "jquery-ui-datepicker" ) );
    ...
    public function registerScriptsAdmin() {
        ...
        wp_register_script("wpjb-admin", $p."admin.js", array("jquery", "wpjb-suggest"), $v);
        ...
        wp_register_script("wpjb-admin-filters", $p."admin-filters.js", array("jquery", "jquery-ui-autocomplete"), $v);
        ...
        wp_register_script("wpjb-admin-config-files-security", $p."admin-config-files-security.js", array("jquery"), $v);
        ...
        wp_register_script("wpjb-admin-import-schedule", $p."admin-import-schedule.js", array("jquery"));
        ...
        wp_register_script("wpjb-admin-user-suggest", $p."admin-user-suggest.js", array("jquery-ui-autocomplete", "jquery"), $v);
    ...
    public function localizeScriptsCommon() {
        ...
        $js_datepicker_date_format = str_replace(array("J"), array("B"), wpjb_date_format());
        $js_datepicker_date_format = str_replace( 
            array( "j", "d", "z", "l", "S", "n", "m", "M", "F", "Y", "y" ),
            array( "d", "dd", "o", "DD", "D", "m", "mm", "M", "MM", "yy", "y" ), $js_date_format );
        $js_months = array();
        ...
        wp_localize_script("wpjb-myresume", "wpjb_myresume_lang", array(
            ...
            "datepicker_date_format" => $js_datepicker_date_format,
    ...
    public function localizeScriptsAdmin() {
        ...
        wp_localize_script("wpjb-admin-import-schedule", "wpjb_admin_import_schedule", array(
            "keyword" => __("Keyword", "wpjobboard"),
            "url" => __("RSS Feed URL", "wpjobboard")
        ));
    ...
    public function registerStylesCommon() {
        ...
        wp_register_style("wpjb-vendor-datepicker", $x."date-picker-v2/css/jquery-ui-date-picker.css");
    ...
    public function adminEnqueueScripts($hook) 
    {
        ...
        if($page == "job" && in_array($action, array("add", "edit"))) {
            ...
            wp_enqueue_script("wpjb-admin-filters");
        } elseif($page == "import" && in_array($action, array("xml", "csv"))) {
            wp_enqueue_script("wpjb-vendor-plupload");
        } elseif($page == "import" && in_array($action, array("add", "edit"))) {
            wp_enqueue_script( "wpjb-admin-import-schedule" );
        ...
        } elseif($page == "config" && $action == "edit" && $request->get("form")=="files-security") {
            wp_enqueue_script("wpjb-admin-config-files-security");
        } elseif($page == "application" && in_array($action, array("add", "edit"))) {
            wp_enqueue_script("suggest");
        } elseif( $page == "config" && $action == "edit" && $request->get("form") == "google-maps" ) {
            ...
            wp_enqueue_script( "wpjb-admin-medialibrary");
        }
    } 

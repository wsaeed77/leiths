        ...
        $config = array(
            array(
                ...
                "item" => array(
                    ...
                    array(
                        "form" => "files-security",
                        "class" => "Wpjb_Form_Admin_Config_FilesSecurity",
                        "icon" => "wpjb-icon-file-archive",
                        "title" => __("Files Security", "wpjobboard"),
                        "order" => 6
                    ),                    
                    array(
                        "form" => "spam",
                    ...
                    array(
                        "form" => "restapi",
                        "class" => "Wpjb_Form_Admin_Config_Rest",
                        "icon" => "wpjb-icon-terminal",
                        "title" => __("Rest API", "wpjobboard"),
                        "order" => 100
                    ),
                )
            ),
            array(
                ...
                "item" => array(
                    ...
                    array(
                        "form" => "google-maps",
                        "class" => "Wpjb_Form_Admin_Config_GoogleMaps",
                        "icon" => "wpjb-icon-google",
                        "title" => __("Google Maps", "wpjobboard"),
                        "order" => 4,
                    ),
                    array(
                        "form" => "recaptcha",

...
class Wpjb_Module_AjaxNopriv_Main 
{
    ...
    public static function deleteAction()
    {
        ...
        $parts = explode( "/", $id );
        $dir = wpjb_upload_dir( $parts[0], $parts[2], $parts[1], "basedir");
        $file = $dir . "/" . basename( $id );
        //$dir = wp_upload_dir();
    ...
    public static function validate($file)
    {
        ...
        $form = new $form( $id, array( "custom" => $form_code ) );
        ...
        foreach( $link->getAll() as $l ) {
            if( attachment_url_to_postid( $l["url"] ) === 0 ) {
                $link->remove( $l["id"] );
            }
        }

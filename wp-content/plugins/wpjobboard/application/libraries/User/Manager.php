...
class Wpjb_User_Manager {
    ...
    protected function _registerEmployer() {
        ...
        $user->dashboard->addPage("application_delete", array("wpjb-employer"=>"application-delete", "wpjb-id"=>"([0-9]{1,})"), array($shortcode, "applicationDelete"));

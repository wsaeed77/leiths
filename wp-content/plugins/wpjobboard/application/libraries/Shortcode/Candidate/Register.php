...
class Wpjb_Shortcode_Candidate_Register extends Wpjb_Shortcode_Abstract {
    ...
    public function onInit() {
        ...
        if(!$this->_form) {
            ...
            $this->_form = new Wpjb_Form_Resumes_Register( null, $form_options );
        }
        ...
        if($this->_form->getObject()->user_id) {
            wpjb_apply_trial($this->_form->getObject()->user_id, "resume");
        }
    ...
    public function main( $atts ) {
        ...
        if(!$this->_form) {
            $this->_form = new Wpjb_Form_Resumes_Register( null, array( "custom"=>$params['form_code'] ) );
        }

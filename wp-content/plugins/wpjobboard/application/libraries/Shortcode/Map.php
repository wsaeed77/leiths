...
class Wpjb_Shortcode_Map extends Wpjb_Shortcode_Abstract 
{
    ...
    public function main($atts = array()) {
        ...
        $pin_icon = plugins_url() . "/wpjobboard/public/images/map/map-marker.png"; 
        $image = wp_get_attachment_image_src( $instance->getConfig( "wpjb_map_default_pin" ) );
        if( isset( $image[0] ) ) {
            $pin_icon = $image[0];
        }
        ...
        foreach( wpjb_get_categories() as $category ) {
            $image = wp_get_attachment_image_src( $instance->getConfig( "wpjb_map_pin_" . $category->id ) );
            if( isset( $image[0] ) ) {
                $all_categories[$category->id] = $image[0];
            }
        }
        ...
        for( $i = 1 ; $i < 6 ; $i++ ) {
            ...
            $img = trim( $instance->getConfig( "wpjb_map_cluster_bg_" . $i, plugins_url() . "/wpjobboard/public/images/map/clusterer-".$i.".png" ) );
            if( is_numeric( $img ) ) {
            ...
            $clusters[$i] = array(
                'textColor' => trim( $instance->getConfig( "wpjb_map_cluster_text_color_" . $i, "#ffffff" ) ),
                "url"       => $img,
            );
        }
        $clusters = apply_filters( "wpjb_map_clusterer", $clusters );
        ...
        var wpjbDefaults = {
            ...
            images: {
                closeBoxURL: "<?php echo plugins_url() ?>/wpjobboard/public/images/a_map_close2.png",
                pin: "<?php echo $pin_icon; ?>",
                ...
                styles: [
                    {
                        ...
                        width: 53,
                        textSize: 20,
                        textColor: "#<?php echo $clusters[1]['textColor']; ?>",
                        url: "<?php echo $clusters[1]['url']; ?>",
                    ...
                    },
                    {
                        ...
                        width: 59,
                        textSize: 20,
                        textColor: "#<?php echo $clusters[2]['textColor']; ?>",
                        url: "<?php echo $clusters[2]['url']; ?>",
                    },
                    {
                        height: 66,
                        width: 66,
                        textSize: 22,
                        textColor: "#<?php echo $clusters[3]['textColor']; ?>",
                        url: "<?php echo $clusters[3]['url']; ?>",
                    ...
                    },
                    {
                        ...
                        width: 78,
                        textSize: 22,
                        textColor: "#<?php echo $clusters[4]['textColor']; ?>",
                        url: "<?php echo $clusters[4]['url']; ?>",
                    },
                    {
                        height: 90,
                        width: 90,
                        textSize: 24,
                        textColor: "#<?php echo $clusters[5]['textColor']; ?>",
                        url: "<?php echo $clusters[5]['url']; ?>",
        ...
        var all_categories_php = <?php echo $all_categories; ?>;

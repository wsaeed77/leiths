...
class Wpjb_Shortcode_Employer_Register extends Wpjb_Shortcode_Abstract {
    ...
    public function onInit() {
        ...
        if(!$this->_form) {
            if( $request->post( "form_code" ) ) {
                $form_options = array( "custom" => $request->post( "form_code" ) );
            } else {
                $form_options = array();
            }
            $this->_form = new Wpjb_Form_Frontend_Register( false, $form_options );
        }
        ...
        if($this->_form->getObject()->user_id) {
            wpjb_apply_trial($this->_form->getObject()->user_id, "employer");
        }
    ...
    public function main($atts) {
        ...
        if(!$this->_form) {
            $this->_form = new Wpjb_Form_Frontend_Register( null, array( "custom"=>$params['form_code'] ) );
        }

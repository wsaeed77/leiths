...
class Wpjb_Shortcode_Manager {
    ...
    public function __construct() {
        ...
        $this->_shortcode["wpjb_single_job"] = new Wpjb_Shortcode_Single_Job();
        $this->_shortcode["wpjb_single_resume"] = new Wpjb_Shortcode_Single_Resume();
        $this->_shortcode["wpjb_single_company"] = new Wpjb_Shortcode_Single_Company();
    }

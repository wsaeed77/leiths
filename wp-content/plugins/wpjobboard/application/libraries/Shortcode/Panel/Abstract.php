    ...
    protected function _hasAccess($capability) {
        if(!current_user_can($capability)) {
            if( $capability == "manage_jobs" ) {
                $m = __("This page is available to Employers only (your account does not have 'employer' capabilities).", "wpjobboard");
            } elseif( $capability == "manage_resumes" ) {
                $m = __("This page is available to Candidates only (your account does not have 'candidate' capabilities).", "wpjobboard");
            } else {

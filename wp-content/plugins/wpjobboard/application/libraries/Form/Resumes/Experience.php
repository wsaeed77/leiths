 ...
 * @author greg
 */
class Wpjb_Form_Resumes_Experience extends Daq_Form_ObjectAbstract
{
    ...
    public function init() 
    {
        ...
        $e->setValue(Wpjb_Model_ResumeDetail::EXPERIENCE);
        $this->addElement($e, "default");
        
        if($this->getObject()->started_at && $this->getObject()->started_at != "0000-00-00") {
        ...
        if($this->getObject()->completed_at && $this->getObject()->completed_at != "0000-00-00") {
        ...
        $e->addOption(1, 1, __("This is my current position", "wpjobboard"));
        ...
        $e->setRequired(true);
        $e->setLabel(__("Position Title", "wpjobboard"));
        $this->addElement($e, "default");
        ...
        apply_filters("wpjr_form_init_resume_experience", $this);
    }
    ...
    public function save($append = array()) 
    {
        ...
        apply_filters("wpjr_form_save_resume_experience", $this);
    }

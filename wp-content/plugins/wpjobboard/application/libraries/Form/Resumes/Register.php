...
class Wpjb_Form_Resumes_Register extends Wpjb_Form_Abstract_Resume
{
    ...
    public function init()
    {
        ...
        if(!isset($this->_group["_internal"])) {
    ...
    public function save($append = array()) {
        ...
        $id = wp_insert_user(array(
            ...
            "role" => apply_filters( "wpjb_user_role", "subscriber", "candidate" )
        ));
        ...
        Wpjb_Model_MetaValue::import("resume", "form_code", $this->value("form_code"), $this->getId());

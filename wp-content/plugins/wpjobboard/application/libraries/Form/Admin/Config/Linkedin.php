...
class Wpjb_Form_Admin_Config_Linkedin extends Daq_Form_Abstract
{
    ...
    public function init()
    {
        ...
        $e = $this->create("linkedin_information", "label");
        $e->setHint(__("LinkedIn for free allows only to automatically post jobs on a private profile. Posting on a company profile is not possible.", "wpjobboard"));

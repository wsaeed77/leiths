...
class Wpjb_Form_Admin_Config_Ziprecruiter extends Daq_Form_Abstract
{
    ...
    public function init()
    {
        ...
        $e->setHint( sprintf( __('Fill the <a href="%s" target="_blank">form</a> and ZipRecruiter team will reach you to claim you API key, It\'s <strong>required</strong> to use ZipRecruiter.', "wpjobboard"), "https://www.ziprecruiter.co.uk/partner#sf_form_container" ) );

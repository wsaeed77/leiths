...
class Wpjb_Form_Admin_AddJob extends Wpjb_Form_Abstract_Job
{
    ...
    public function init()
    {
        ...
        $e->setValue($this->ifNew( date( wpjb_date_format() ), $this->_object->job_created_at) );
        ...
        $e->setDateFormat(wpjb_date_format());
        $e->setValue($this->ifNew( date( wpjb_date_format(), $t), $this->_object->job_expires_at ) );
        $this->addElement($e, "_internal");
    ...
    {         
        ...
        Wpjb_Model_MetaValue::import( "job", "form_code", $form_code, $this->getId() );

        $application_form_code = Daq_Request::getInstance()->post( "application_form_code", null );
        Wpjb_Model_MetaValue::import( "job", "application_form_code", $application_form_code, $this->getId() );

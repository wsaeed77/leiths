...
class Wpjb_Form_Admin_ScheduleImport extends Daq_Form_ObjectAbstract
{
    ...
    public function init()
    {
        ...
        $e->addOption("rss", "rss", __("RSS Feed", "wpjobboard"));
    ...
    public function isValid(array $values) {
        ...
        if( $values["engine"] == "rss") {
            $this->getElement("keyword")->setRequired(true);
            $this->getElement("keyword")->addValidator(new Daq_Validate_Url);
            $values["category_id"] = "";
            $values["country"] = "";
            $values["location"] = "";
        }

...
class Wpjb_Form_Admin_Pricing_CandidateMembership extends Wpjb_Form_Admin_Pricing
{
    ...
    public function init()
    {
        ...
        $e->addOption("1", "1", __("Automatically apply this membership to every newly registered Candidate.", "wpjobboard"));
        $e->setOrder(101);
        ...
        $e->setOrder(106);
        if( isset( $this->getObject()->meta->is_searchable ) ) {
        ...
        $e->setOrder(106);
        if( isset( $this->getObject()->meta->can_apply ) ) {
        ...
        $e->setOrder(107);
        if( isset( $this->getObject()->meta->featured_level ) ) {
        ...
        $e->setOrder(108);
        if( isset( $this->getObject()->meta->alert_slots ) ) {

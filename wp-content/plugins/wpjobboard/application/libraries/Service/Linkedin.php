...
class Wpjb_Service_Linkedin {
    ...
    protected static function _share( $object ) {
        ...
        $parameters["comment"] = wp_strip_all_tags( $parser->draw($parameters["comment"]) );
        $parameters["title"] = wp_strip_all_tags( $parser->draw($parameters["title"]) );
        $parameters["description"] = wp_strip_all_tags( $parser->draw($parameters["description"]) );
        ...
        if( isset( $parameters["description"] ) ) {
            $media_obj->description = new stdClass();
        ...
        if( isset( $parameters["comment"] ) ) {
            $data->specificContent = new stdClass();
            $data->specificContent->{"com.linkedin.ugc.ShareContent"} = new stdClass();
            $data->specificContent->{"com.linkedin.ugc.ShareContent"}->shareCommentary = new stdClass();

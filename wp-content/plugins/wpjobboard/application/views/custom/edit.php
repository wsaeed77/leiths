<div class="wrap wpjb">
    ...
    <h1>
        ...
        <a href="<?php echo wpjb_admin_url( "custom" ); ?>" class="add-new-h2" ><?php _e(" Go Back", "wpjobboard" ); ?></a>
    </h1>
...
<div class="wpjb-toolbox wpjb-toolbox-config" id="">
    <div class="handlediv" title="<?php _e("Click to toggle", "wpjobboard") ?>"><br /></div>
    <h3 class="hndle"><span><?php _e("Basic Configuration", "wpjobboard") ?></span></h3>
    <div class="inside">
        <div class="wpjb_form_config">
            <input type="hidden" name="form_type" id="form_type" value="<?php echo esc_html( $_GET['form'] ); ?>" />
            <div>
                <div class="wpjb_form_config_label"><label for="form_label"><?php _e("Label", "wpjobboard"); ?></label></div>
                <div class="wpjb_form_config_field"><input type="text" name="form_label" id="form_label" value="<?php echo esc_html( $formConfig['form_label'] ); ?>" /></div>
            </div>
            <div>
                <div class="wpjb_form_config_label"><label for="form_code"><?php _e("Code", "wpjobboard"); ?></label></div>
                <div class="wpjb_form_config_field"><input type="text" name="form_code" id="form_code" value="<?php echo esc_html( $formConfig['form_code'] ); ?>" readonly /></div>
            </div>
            <div>
                <div class="wpjb_form_config_label"><label for="form_is_active"><?php _e("Default", "wpjobboard"); ?></label></div>
                <div class="wpjb_form_config_field"><input type="checkbox" name="form_is_active" id="form_is_active" value="1" <?php if( (bool)$formConfig['form_is_active'] ): ?>checked="checked"<?php endif; ?> /><?php _e("Form is default", "wpjobboard"); ?></div>
            </div>
        </div>
    </div>
</div>
...
<div class="wpjb-toolbox wpjb-toolbox-default" id="">
    <div class="handlediv" title="<?php _e("Click to toggle", "wpjobboard") ?>"><br /></div>
    <h3 class="hndle hndlei"><span><?php _e("Basic Fields", "wpjobboard") ?></span></h3>
    <div class="inside">
...
<?php endif; ?>
    ...
    <div>
        ...
        <div id="ve-save-failed-custom" class="wpjb-error" title="<?php _e("Click to dispose", "wpjobboard") ?>"><?php _e("Unexpected error, the form could not be saved.", "wpjobboard") ?></div>
    </div>
</div>
            ...
            <form action="" method="post">
                <table>
                    <tbody>
                        ...
                        <?php do_action( "wpjb_custom_field_config", "general" ); ?>
                    </tbody>
                </table>
            </form>
        </div>
            ...
            <form action="" method="post">
                <table>
                    <tbody>
                        ...
                        <tr class="field-year-range">
                            <td>
                                <?php _e("Year Range", "wpjobboard") ?>
                                <small><?php _e('The range of years displayed in the year drop-down. (<a href="https://api.jqueryui.com/datepicker/#option-yearRange" target="_blank">see docs</a>)', "wpjobboard") ?></small>
                            </td>
                            <td>
                                <input type="text" name="validation_year_range" id="validation_year_range" placeholder="c-10:c+10" />
                            </td>
                        </tr>

                        <tr class="field-target">
                            <td><?php _e("Target<small>Defines how to open URL</small>", "wpjobboard") ?></td>
                            <td>
                                <select name="url_target">
                                    <option value=""></option>
                                    <option value="_self"><?php _e("Default", "wpjobboard") ?></option>
                                    <option value="_blank"><?php _e("New Window/Tab", "wpjobboard") ?></option>
                                </select>
                            </td>
                        </tr>
            ...
            <form action="" method="post">
                <table>
                    <tbody>
                        ...
                        <tr class="field-multi-display">
                            <td><?php _e("Content Display<small>How selected options should be visible</small>", "wpjobboard") ?></td>
                            <td>
                                <select name="content_display">
                                    <option value="inline"><?php _e( "Inline, separated by comma", "wpjobboard" ); ?></option>
                                    <option value="list"><?php _e( "List (one option = one line)", "wpjobboard" ); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr class="field-required">

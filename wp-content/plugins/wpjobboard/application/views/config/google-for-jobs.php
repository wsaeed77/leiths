                ...
                <div class="postbox wpjb-form-postbox wpjb-namediv wpjb-form-group-preview">
                    ...
                    <div class="inside wpjb-gfj-preview-none">   
                        ...
                        <div class="inside" style="padding: 12px">
                            <?php echo sprintf(__("You need to <a href=\"%s\">add</a> at least one job to use preview.", "wpjobboard"), wpjb_admin_url("job", "add")) ?>
                        </div>
...
<script type="text/html" id="tmpl-wpjb-gfj-map-MonetaryAmount">
    ...
    <div class="wpjb-gfj-item-edit">
        ...
        <div class="wpjb-gfj-item-edit-inner">
            ...
            <div class="wpjb-gfj-item-edit-label">
                <strong>{{ data.label }} - <?php _e("Min Value", "wpjobboard" ) ?></strong>
            </div>
            ...
            <div class="wpjb-gfj-item-edit-input" data-name="minValue" >
                <select class="wpjb-gfj-internal-field-map" name="internal_field_name">
                    <option value="inherit"><?php _e("Inherit", "wpjobboard") ?></option>
                    <?php foreach($fields as $key => $opt): ?>
                    <option <# if( data.value.minValue.name == "<?php echo esc_attr($opt["key"]) ?>") { #>selected="selected"<# } #> value="<?php echo esc_attr($opt["key"]) ?>"><?php echo esc_html($opt["label"]) ?></option>
                    <?php endforeach; ?>
                </select>
                
                <input type="text" class="wpjb-gfj-internal-text-value" value="{{ data.value.minValue.text }}" style="display: none" placeholder="<?php echo esc_attr(__("Enter text here ...", "wpjobboard")) ?>" />
            </div>
        </div>
        ...
        <div class="wpjb-gfj-item-edit-inner">
            ...
            <div class="wpjb-gfj-item-edit-label">
                <strong>{{ data.label }} - <?php _e("Max Value", "wpjobboard" ) ?></strong>
            </div>
            ...
            <div class="wpjb-gfj-item-edit-input"data-name="maxValue" >
                <select class="wpjb-gfj-internal-field-map" name="internal_field_name">
                    <option value="inherit"><?php _e("Inherit", "wpjobboard") ?></option>
                    <?php foreach($fields as $key => $opt): ?>
                    <option <# if( data.value.maxValue.name == "<?php echo esc_attr($opt["key"]) ?>") { #>selected="selected"<# } #> value="<?php echo esc_attr($opt["key"]) ?>"><?php echo esc_html($opt["label"]) ?></option>
                    <?php endforeach; ?>
                </select>
                
                <input type="text" class="wpjb-gfj-internal-text-value" value="{{ data.value.maxValue.text }}" style="display: none" placeholder="<?php echo esc_attr(__("Enter text here ...", "wpjobboard")) ?>" />
            </div>
        </div>
        ...
        <div class="wpjb-gfj-item-edit-inner">
            ...
            <div class="wpjb-gfj-item-edit-label">
                <strong>{{ data.label }} - <?php _e("Unit Text", "wpjobboard" ) ?></strong>
            </div>
            ...
            <div class="wpjb-gfj-item-edit-input"data-name="unitText" >
                <select class="wpjb-gfj-internal-field-map" name="internal_field_name">
                    <option value="inherit"><?php _e("Inherit", "wpjobboard") ?></option>
                    <?php foreach($fields as $key => $opt): ?>
                    <option <# if( data.value.unitText.name == "<?php echo esc_attr($opt["key"]) ?>") { #>selected="selected"<# } #> value="<?php echo esc_attr($opt["key"]) ?>"><?php echo esc_html($opt["label"]) ?></option>
                    <?php endforeach; ?>
                </select>
                
                <input type="text" class="wpjb-gfj-internal-text-value" value="{{ data.value.unitText.text }}" style="display: none" placeholder="<?php echo esc_attr(__("Enter text here ...", "wpjobboard")) ?>" />
            </div>
        </div>
    ...
    <div class="wpjb-gfj-item-view">
        <span class="wpjb-gfj-item-view-map">
            <div>
                <span class="dashicons {{ data._dashicon }}"></span>
                {{ data.label }} - <?php _e("Value", "wpjobboard" ) ?>
                <span class="dashicons dashicons-arrow-right-alt2"></span>
                {{ data.value.value.label }}
            </div>
            <div>
                <span class="dashicons {{ data._dashicon }}"></span>
                {{ data.label }} - <?php _e("Min. Value", "wpjobboard" ) ?>
                <span class="dashicons dashicons-arrow-right-alt2"></span>
                {{ data.value.minValue.label }}
            </div>
            <div>
                <span class="dashicons {{ data._dashicon }}"></span>
                {{ data.label }} - <?php _e("Max. Value", "wpjobboard" ) ?>
                <span class="dashicons dashicons-arrow-right-alt2"></span>
                {{ data.value.maxValue.label }}
            </div>
            <div>
                <span class="dashicons {{ data._dashicon }}"></span>
                {{ data.label }} - <?php _e("Unit Text", "wpjobboard") ?>
                <span class="dashicons dashicons-arrow-right-alt2"></span>
                {{ data.value.unitText.label }}
            </div>
            <div>
                <span class="dashicons {{ data._dashicon }}"></span>
                {{ data.label }} - <?php _e("Currency", "wpjobboard") ?>
                <span class="dashicons dashicons-arrow-right-alt2"></span>

	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td class="post-title column-title column-primary">
                ...
                <div class="row-actions">
                    ...
                    <span class=""><a href="<?php echo wpjb_admin_url("applicationStatus", "delete", $i,  array("noheader"=>1, "_wpjb_nonce"=>$nonce)) ?>" title="<?php _e("Delete", "wpjobboard") ?>" class="wpjb-delete"><?php _e("Delete", "wpjobboard") ?></a></span>
                </div>
                <button type="button" class="toggle-row">
                    <span class="screen-reader-text"><?php _e("Show more details") ?></span>
                </button>
            </td>
            <!--td data-colname="<?php esc_attr_e("Description", "wpjobboard") ?>" class=""><?php echo isset($item["description"]) ? esc_html($item["description"]) : "" ?></td-->
            ...
            <!--td data-colname="<?php esc_attr_e("Order", "wpjobboard") ?>" class=""><?php echo isset($item["order"]) ? esc_html($item["order"]) : 0 ?></td-->
            <td data-colname="<?php esc_attr_e("Example", "wpjobboard") ?>" class=""><span class="wpjb-bulb" style="<?php echo isset($item["color"]) ? sprintf("background-color:%s;", $item["color"] ) : "" ?><?php echo isset($item["tcolor"]) ? sprintf("color:%s;", $item["tcolor"]) : ""; ?>"><?php echo esc_html( $item["label"] ) ?></span></td>

	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td class="post-title column-title column-primary">
                ...
                <div class="row-actions">
                    ...
                    <span class=""><a href="<?php echo wpjb_admin_url("pricing", "delete", $item->id, array("listing"=>$listing,"noheader"=>1, "_wpjb_nonce"=>$nonce)) ?>" title="<?php _e("Delete", "wpjobboard") ?>" class="wpjb-delete"><?php _e("Delete", "wpjobboard") ?></a> | </span>
                </div>
            ...
            <td data-colname="<?php esc_attr_e("Price", "wpjobboard") ?>" class="">
                <?php if(Wpjb_List_Currency::exists($item->currency)): ?>
                <?php echo wpjb_price($item->price, $item->currency) ?>
                <?php else: ?>
                <span class="dashicons dashicons-warning" title=""></span>
                <?php _e("Currency not found", "wpjobboard") ?>
                <?php endif; ?>
            </td>
            <?php if($listing == "single-job"): ?>

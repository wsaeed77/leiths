...
<h1>
    ...
    <a class="add-new-h2 add-new-h2-right-open" href="<?php echo wpjb_admin_url("resumes", "add") ?>">
        <?php _e("Add New", "wpjobboard") ?>
    </a> 

    <div class="wpjb_additional_option_button">
        <a class="add-new-h2 add-new-h2-left-open wpjb_additional_forms" href="<?php esc_html_e( wpjb_admin_url("resumes", "add") ) ?>">
        ...
        <div class="wpjb_additional_options_box">
            ...
            <?php foreach( $forms as $f ): ?>
                ...
                <li>
                    <a href="<?php echo esc_html( wpjb_admin_url("resumes", "add") ); ?>&form_code=<?php echo esc_html( $f ); ?>">

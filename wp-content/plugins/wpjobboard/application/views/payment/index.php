	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td class="post-title column-title column-primary">
                ...
                <div class="row-actions">
                    ...
                    <span><a href="<?php echo esc_html(wpjb_admin_url( "payment", "markpaid", $item->getId(), array("noheader"=>1, "_wpjb_nonce"=>$nonce))) ?>" class="wpjb-payment-mark-paid"><?php _e("Mark as Paid", "wpjobboard") ?></a> | </span>
                    <span><a href="<?php echo esc_html(wpjb_admin_url( "payment", "delete", $item->getId(), array("noheader"=>1, "_wpjb_nonce"=>$nonce))) ?>" class="wpjb-delete"><?php _e("Delete", "wpjobboard") ?></a> </span>
                </div>

	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td class="post-title column-title column-primary">
                ...
                <div class="row-actions">
                    ...
                    <span class=""><a href="<?php echo wpjb_admin_url("discount", "delete", $item->getId(), array("noheader"=>1, "_wpjb_nonce"=>$nonce)) ?>" title="<?php _e("Delete", "wpjobboard") ?>" class="wpjb-delete"><?php _e("Delete", "wpjobboard") ?></a> | </span>
                </div>

...
<h1>
    <?php _e("Jobs", "wpjobboard") ?> 
    
    <a class="add-new-h2 add-new-h2-right-open" href="<?php esc_html_e(wpjb_admin_url("job", "add")) ?>">
        <?php _e("Add New", "wpjobboard") ?>
    </a> 

    <div class="wpjb_additional_option_button">
        <a class="add-new-h2 add-new-h2-left-open wpjb_additional_forms" href="<?php esc_html_e(wpjb_admin_url("job", "add")) ?>">
        ...
        <div class="wpjb_additional_options_box">
            ...
            <?php foreach( $forms as $f ): ?>
                ...
                <li>
                    <a href="<?php echo esc_html( wpjb_admin_url( "job", "add" ) ); ?>&form_code=<?php echo esc_html( $f ); ?>">
...
<table cellspacing="0" class="widefat post fixed wp-list-table">
    ...
    <<?php echo $tx; ?>>
        <tr>
            ...
            <?php if($screen->show("job", "job_address")): ?>
            <th class="" scope="col"><?php _e("Address", "wpjobboard") ?></th>
            <?php endif; ?>
        ...
        <tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?> iedit <?php if($item->requiresAdminAction()): ?>wpjb-unread<?php endif; ?>">
            ...
            <td class="post-title column-title column-primary">
                ...
                <div class="row-actions">
                    ...
                    <span class=""><a rel="permalink" class="wpjb-delete wpjb-no-confirm" title="<?php _e("Delete", "wpjobboard") ?>" href="<?php echo wpjb_admin_url("job", "remove")."&".http_build_query(array("users"=>array($item->id))); ?>"><?php _e("Delete", "wpjobboard") ?></a></span>
                </div>
            ...
            <?php if($screen->show("job", "job_address")): ?>
            <td data-colname="<?php esc_attr_e("Address", "wpjobboard") ?>">
                <?php esc_html_e($item->job_address) ?>
            </td>
            <?php endif; ?>
            ...
            <td data-colname="<?php esc_attr_e("Applications", "wpjobboard") ?>">
                <a href="<?php esc_attr_e(wpjb_admin_url("application", "index", null, array("query"=>"job:".$item->id))) ?>">
                    <?php echo $item->applications(null, "id") ?> 
                </a>
                
                <?php if($item->applications("1", "id") > 0): ?>
                <a href="<?php esc_attr_e(wpjb_admin_url("application", "index", null, array("query"=>"job:".$item->id, "filter"=>"new"))) ?>">
                    <strong><?php printf(str_replace(" ", "&nbsp;", __("(%d new)", "wpjobboard")), $item->applications("1", "id")) ?></strong>
                </a>
                <?php endif; ?>
            </td>
            <?php endif; ?>

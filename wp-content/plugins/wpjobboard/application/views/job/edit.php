...
<h1>
    <?php printf(__("Edit Job '<strong>%s</strong>'", "wpjobboard"), esc_html( $form->getObject()->job_title) ) ?> 
...
<div id="poststuff" >
    ...
    <div id="post-body" class="metabox-holder columns-2">
        <div id="post-body-content">
            ...
            <?php daq_form_layout( $form, array("exclude_fields"=>"payment_method", "exclude_hidden" => "form_code", "exclude_groups"=>"_internal") ); ?>
        ...
        <div id="postbox-container-1" class="postbox-container">
            ...
            <div class="wpjb-sticky" id="side-info-column">
                ...
                <div class="misc-pub-section curtime ">
                    <span id="form_code_span"><?php _e("Used Form:", "wpjobboard") ?> <b class=""> 
                        <?php if( isset( $form->getObject()->meta->form_code ) && $form->getObject()->meta->form_code->value() != null ): ?>
                            ...
                            <?php $full_form = $full_form ?? ['config'=>['form_label'=>null]] ?>
                            <?php $form_detail = $full_form['config']; ?>
                            
                            <span class="form_code_used"><?php echo esc_html( $form_detail['form_label'] ) ?></span>
                            <?php if( !wpjb_if_form_exist( $form->getObject()->meta->form_code->value(), "job" ) ): ?>
                    ...
                    <div class="form_code_box hide-if-js">
                        ...
                        <?php $form_code = "" ?> 
                        <?php if( isset( $form->getObject()->meta->form_code ) ): $form_code = $form->getObject()->meta->form_code->value(); endif; ?>
                        ...
                        <?php if( isset( $form->getObject()->meta->form_code ) && $form->getObject()->meta->form_code->value() == $f): ?>
                ...
                <div class="misc-pub-section curtime ">
                    <span id="application_form_code_span"><?php _e("Application Form:") ?> <b class=""> 
                        <?php if( isset( $form->getObject()->meta->application_form_code ) && $form->getObject()->meta->application_form_code->value() != null ): ?>
                            
                            <?php $full_form = maybe_unserialize( get_option( $form->getObject()->meta->application_form_code->value(), null ) ); ?>
                            <?php $form_detail = $full_form['config']; ?>
                            
                            <span class="application_form_code_used"><?php echo esc_html( $form_detail['form_label'] ) ?></span>
                            <?php if( !wpjb_if_form_exist( $form->getObject()->meta->application_form_code->value(), "apply" ) ): ?>
                                <span class="application_form_code_used"><?php _e( "(Form No Longer Exist)", "wpjobboard" ); ?></span>
                            <?php endif; ?>
                        <?php else: ?>
                            <span class="application_form_code_used"><?php _e( "No Form Saved", "wpjobboard" ); ?></span>
                        <?php endif; ?>
                    </b></span>

                    <a id="application_form_code_link" class="edit-timestamp hide-if-no-js" href="#"><?php _e("Edit") ?></a>

                    <div class="application_form_code_box hide-if-js">
                        <?php $forms_list = get_option( "wpjb_forms_list" ); ?>
                        <?php $application_form_code = "" ?> 
                        <?php if( isset( $form->getObject()->meta->application_form_code ) ): $application_form_code = $form->getObject()->meta->application_form_code->value(); endif; ?>
                        <select id="application_form_code" name="application_form_code" size="1" data-initial-value="<?php echo $application_form_code ?>">
                        <?php foreach( $forms_list['apply']  as $f ): ?>
                        <?php $f_details = maybe_unserialize( get_option( $f, null ) ); ?>
                        <?php if( isset( $form->getObject()->meta->application_form_code ) && $form->getObject()->meta->application_form_code->value() == $f): ?>
                        <option selected="selected" value="<?php echo $f; ?>"><?php echo $f_details['config']['form_label']; ?></option>
                        <?php else: ?>
                        <option value="<?php echo $f; ?>"><?php echo $f_details['config']['form_label']; ?></option>
                        <?php endif; ?>
                        ...
                        <a href="#" id="application_form_code-cancel"><?php _e("Cancel", "wpjobboard") ?></a>
                    </div>
                </div>
                ...
                <div id="major-publishing-actions">
                    <div id="delete-action">
                        <a href="<?php echo wpjb_admin_url( "job", "remove" ) . "&".http_build_query( array( "users"=>array( $form->getId() ) ) ); ?>" class="submitdelete deletion"><?php _e("Delete") ?></a>
                    </div>

<div class="wrap wpjb">
    ...
    <h1>
        <?php if($form->getId() > 0): ?>
            <?php printf( __("Edit Alert (ID: %s)", "wpjobboard"), intval( $form->getObject()->id ) ) ?> 
        <?php else: ?>
            <?php printf( __("Add New Alert", "wpjobboard"), intval( $form->getObject()->id ) ) ?> 
        <?php endif; ?>
                                    ...
                                    <div id="submitpost" class="submitbox">
                                        <div id="minor-publishing">
                                            ...
                                            <div class="misc-pub-section wpjb-inline-section curtime">
                                                <span id="timestamp"><?php _e("Alert Created", "wpjobboard") ?>: <b><?php echo esc_html( wpjb_date($form->getObject()->created_at ?? current_time("mysql")) ) ?></b></span>
                                            </div>
                                        ...
                                        <div id="major-publishing-actions">  
                                            ...
                                            <div id="delete-action">
                                                <a href="<?php esc_attr_e(wpjb_admin_url("alerts", "delete", $form->getObject()->id, array("noheader"=>1,"_wpjb_nonce"=>$nonce))) ?>" class="submitdelete deletion wpjb-delete-item-confirm"><?php _e("Delete", "wpjobboard") ?></a>
                                            </div>
                                    ...
                                    <div id="submitpost" class="submitbox">
                                        <div id="minor-publishing">
                                            <div class="misc-pub-section wpjb-grid">
                                                ...
                                                <?php $logs = maybe_unserialize($form->getObject()->logs); ?>
                                                ...
                                                <div class="wpjb-grid-row wpjb-manage-item">
                                                    ...
                                                    <table class="wpjb-small-table">
                                                        ...
                                                        <tr>
                                                            <td style="width: 30%; padding:0px;">
                                                                <a href="#" class="wpjb-alert-show-log" data-id="<?php echo intval( $i ); ?>">
                                                        ...
                                                        <tr id="wpjb-alert-log-<?php echo intval( $i ); ?>" class="wpjb-grid wpjb-manage-action wpjb-col-100" style="width: 100%; background-color: whitesmoke; display: none;"> 
                                                            <td colspan="2">

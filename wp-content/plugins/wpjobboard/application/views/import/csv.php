...
var WpjbImportUrl = {
    clearqueue: "<?php echo html_entity_decode(wpjb_admin_url("import", "clearqueue", null, array("noheader"=>1,"_nonce"=>$nonce))) ?>",
    upload: "<?php echo html_entity_decode(wpjb_admin_url("import", "xmlupload", null, array("noheader"=>1,"_nonce"=>$nonce))) ?>",
    count: "<?php echo html_entity_decode(wpjb_admin_url("import", "csvcount", null, array("noheader"=>1,"_nonce"=>$nonce))) ?>",
    import: "<?php echo html_entity_decode(wpjb_admin_url("import", "csvimport", null, array("noheader"=>1,"_nonce"=>$nonce))) ?>"
};
var WpjbCanUnzip = 0;
var WpjbImport = {
    filters: [

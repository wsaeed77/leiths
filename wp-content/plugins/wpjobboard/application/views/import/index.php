...
<table cellspacing="0" class="widefat post fixed wp-list-table">
    ...
    <<?php echo $tx; ?>>
        <tr>
            ...
            <th class="column-primary" scope="col" style="width:150px"><?php _e("Engine", "wpjobboard") ?></th>
            <th class="" scope="col" style="width:auto"><?php _e("Params", "wpjobboard") ?></th>
            <th class="" scope="col" style="width:150px"><?php _e("Last Run", "wpjobboard") ?></th>
            <th class="" scope="col" style="width:150px"><?php _e("Status", "wpjobboard") ?></th>
        </tr>
    </<?php echo $tx; ?>>
    <?php endforeach; ?>
    ...
    <tbody id="the-list">
        ...
        <tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?> author-self status-publish iedit">
            ...
            <td class="column-title column-primary">
                <strong><a title="<?php _e("Edit", "wpjobboard") ?>" href="<?php esc_attr_e(wpjb_admin_url("import", "edit", $item->id)) ?>" class="wpjb-row-title"><?php esc_html_e(ucfirst($item->engine) ) ?></a> <?php echo sprintf( "(ID: %d)", intval( $item->id ) ) ?></strong>
                <div class="row-actions">
                    <span class="edit"><a href="<?php esc_attr_e(wpjb_admin_url("import", "edit", $item->id)) ?>"><?php _e("Edit", "wpjobboard") ?></a> | </span>
                    <span class=""><a href="<?php esc_attr_e(wpjb_admin_url("import", "delete", $item->id, array("noheader"=>1, "_wpjb_nonce"=>$nonce))) ?>" title="<?php _e("Delete", "wpjobboard") ?>" class="wpjb-delete"><?php _e("Delete", "wpjobboard") ?></a> | </span>
                </div>
            ...
            <td data-colname="<?php esc_attr_e("Keyword", "wpjobboard") ?>">
                <?php echo ($item->getReadableParams()) ?>
            </td>

...
<h1>
    ...
    <div class="wpjb-export-all">
        ...
        <p>
            ...
            <?php else: ?>
            <?php _e( "Your server does not have ZipArchive installed. Please contact your server company, and ask them to install it for you to be able to perform the export action.", "wpjobboard" ); ?>
            <?php endif; ?>
        </p>

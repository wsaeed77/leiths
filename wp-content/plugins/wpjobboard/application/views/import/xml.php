...
var WpjbImportUrl = {
    ...
    count: "<?php echo html_entity_decode(wpjb_admin_url("import", "xmlcount", null, array("noheader"=>1,"_nonce"=>$nonce))) ?>",
    import: "<?php echo html_entity_decode(wpjb_admin_url("import", "xmlimport", null, array("noheader"=>1,"_nonce"=>$nonce))) ?>"
};
var WpjbImport = {
    filters: [
        <?php if($canUnzip): ?>

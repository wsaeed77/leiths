	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?> author-self status-publish iedit">
            ...
            <td class="post-title column-title column-primary">
                ...
                <div class="row-actions">
                    ...
                    <span class=""><a href="<?php echo wpjb_admin_url("memberships", "delete", $item->id,  array("noheader"=>1, "_wpjb_nonce"=>$nonce)) ?>" title="<?php _e("Delete", "wpjobboard") ?>" class="wpjb-delete"><?php _e("Delete", "wpjobboard") ?></a></span>
                </div>
            ...
            <td data-colname="<?php esc_attr_e("Status", "wpjobboard") ?>">
                ...
                <?php $sub_status = Wpjb_Model_MetaValue::getSingle( 'membership', 'subscription_status', $item->id ); ?>

                <?php if( $package->meta->is_recurring->value() == 1 && $sub_status->value == "-1" ): ?>
                <span class="wpjb-bulb wpjb-bulb-expiring" style="background-color: #D54E21"><?php _e("Canceled", "wpjobboard") ?></span>
                <?php elseif ( $package->meta->is_recurring->value() == 1 ): ?>
                <span class="wpjb-bulb wpjb-bulb-active"><?php _e("Recurring", "wpjobboard") ?></span>
                <?php endif; ?>

...
<h1>
    ...
    <a class="add-new-h2 add-new-h2-right-open" href="<?php echo wpjb_admin_url("employers", "add") ?>">
        <?php _e("Add New", "wpjobboard") ?>
    </a> 

    <div class="wpjb_additional_option_button">
        <a class="add-new-h2 add-new-h2-left-open wpjb_additional_forms" href="<?php esc_html_e( wpjb_admin_url("employer", "add") ) ?>">
        ...
        <div class="wpjb_additional_options_box">
            ...
            <?php foreach( $forms as $f ): ?>
                ...
                <li>
                    <a href="<?php echo esc_html( wpjb_admin_url("employers", "add") ); ?>&form_code=<?php echo esc_html( $f ); ?>">
    ...
    <tbody id="the-list">
        ...
        <tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?> <?php if($item->is_verified == Wpjb_Model_Company::ACCESS_PENDING): ?>wpjb-unread<?php endif; ?> author-self status-publish iedit">
            ...
            <td data-colname="<?php esc_attr_e("Representative", "wpjobboard") ?>" class="author column-author">
                <strong><a href="user-edit.php?user_id=<?php echo $user->ID ?>"><?php echo esc_html($user->display_name." (ID: ".intval( $user->ID ).")") ?></a></strong>
            </td>
            <?php endif; ?>

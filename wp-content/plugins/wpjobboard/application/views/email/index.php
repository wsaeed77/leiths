...
<table cellspacing="0" class="widefat post fixed wp-list-table">
    ...
    <<?php echo $tx; ?>>
        <tr>
            ...
            <th style="width:20%" class="" scope="col"><?php _e("Name", "wpjobboard") ?></th>
            <th style="width:20%" class="column-icon" scope="col"><?php _e("Mail From", "wpjobboard") ?></th>
            <th style="width:10%" class="column-icon" scope="col"><?php _e("Status", "wpjobboard") ?></th>
        </tr>
    </<?php echo $tx; ?>>
    <?php endforeach; ?>
	...
	<tr valign="top" class="<?php if($i%2==0 || true): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td data-colname="<?php esc_attr_e("Status", "wpjobboard") ?>" class="author column-author">
                <?php if( $item->is_active ): ?>
                    <span class="wpjb-bulb  wpjb-bulb-new"><?php _e( "Active", "wpjobboard" ); ?></span>
                <?php else: ?>
                    <span class="wpjb-bulb  wpjb-bulb-active"><?php _e( "Inactive", "wpjobboard" ); ?></span>
                <?php endif; ?>
            </td>
        </tr>
        <?php $i++; ?>

        ...
        <div class="wpjb-grid-row wpjb-manage-item <?php wpjb_panel_features($job) ?>">
            ...
            <div class="wpjb-grid-col wpjb-col-100">
                ...
                <div class="wpjb-manage-actions-more">
                    ...
                    <?php if($job->is_filled): ?>
                    <a href="<?php echo wpjb_api_url("action/job", array("id"=>$job->id, "do"=>"unfill", "redirect_to"=>wpjb_cypher_text($url, "wpjb_redirection_url"))) ?>" class="wpjb-manage-action">
                        <span class="wpjb-glyphs wpjb-icon-user-circle-o"></span>
                        <?php _e("Mark as not filled", "wpjobboard") ?>
                    </a>
                    <?php else: ?>
                    <a href="<?php echo wpjb_api_url("action/job", array("id"=>$job->id, "do"=>"fill", "redirect_to"=>wpjb_cypher_text($url, "wpjb_redirection_url"))) ?>" class="wpjb-manage-action">

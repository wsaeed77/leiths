            ...
            <div>
                ...
                <ul class="wpjb-top-header-subtitle">
                    ...
                    <li class="wpjb-job-company-url">
                        ...
                        <?php $job_form = new Wpjb_Form_AddJob(); $url_target = null; if( $job_form->hasElement( "company_url") ): $url_target = $job_form->getElement("company_url")->getAttr("url_target"); endif; ?>
                        <a href="<?php echo esc_attr($job->company_url) ?>" target="<?php echo esc_html( $url_target ); ?>" class="wpjb-maybe-blank"><?php echo esc_html(parse_url($job->company_url, PHP_URL_HOST)) ?></a>
                    </li>
                    <?php endif; ?>

            ...
            <div class="wpjb-grid-col wpjb-col-90" style="width:calc( 100% - 60px )">
                ...
                <div class="wpjb-manage-actions-wrap">
                    ...
                    <span class="wpjb-manage-actions-left">
                        ...
                        <a href="<?php echo wpjb_link_to("application_delete", $application); ?>" title="<?php _e("Delete", "wpjobboard") ?>" class="wpjb-manage-action wpjb-manage-action-delete" data-id="<?php echo $application->id ?>" data-nonce="<?php echo wp_create_nonce('wpjobboard-manage-delete') ?>">

...
<div class="wpjb wpjb-page-memberships">
    ...
    <div class="wpjb-single-membership <?php if( $pricing->id == $featured || ( !isset($featured) && $pricing->meta->is_featured->value() == 1 ) ): ?>wpjb-single-membership-featured<?php endif; ?> wpjb-single-membership-<?php echo $pricing->id; ?>">
        ...
        <div class="wpjb-membership-details">
            ...
            <?php if( isset( $package['have_access'] ) && $package['have_access'] ): ?>

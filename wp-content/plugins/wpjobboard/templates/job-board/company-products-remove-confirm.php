...
<div class="wpjb wpjb-page-company-home">
    ...
    <div class="wpjb-upload-ui">
        <div class="wpjb-upload-inner">
            ...
            <span><a href="<?php echo wpjb_link_to("membership"); ?>?action=cancel&id=<?php echo $membership->id; ?>&confirm=yes" class="wpjb-button wpjb-button-primary"><?php _e("Confirm", "wpjobboard"); ?></a></span>
            <span><a href="<?php echo wpjb_link_to("membership"); ?>" class="wpjb-button wpjb-button-primary"><?php _e("Cancel", "wpjobboard"); ?></a></span>
        </div>
    </div>

    ...
    <div class="wpjb-grid wpjb-grid-job-application-details">
        ...
        <div class="wpjb-grid-row">
           ...
           <div class="wpjb-col-65 wpjb-glyphs wpjb-icon-link-ext-alt">
                ...
                <?php if(!$resume->exists()):?>
                <span><?php _e("User does not have a resume.","wpjobboard") ?></span>
                <?php elseif(!$resume->hasActiveProfile()): ?>
                <span><?php _e("User made his resume private.","wpjobboard") ?></span>
                <?php else: ?>
        ...
        <div class="wpjb-grid-row">
            ...
            <div class="wpjb-col-65 wpjb-glyphs wpjb-icon-mail-alt">
                <a href="mailto:<?php echo esc_html($application->email) ?>"><?php echo esc_html($application->email) ?></a>
            </div>
        </div>        
        <div class="wpjb-grid-row">
            <div class="wpjb-col-30">

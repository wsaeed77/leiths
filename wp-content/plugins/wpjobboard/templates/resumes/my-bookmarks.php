    ...
    <div class="wpjb-grid wpjb-grid wpjb-grid-compact">
        ...
        <div class="wpjb-grid-row">
            ...
            <div class="wpjb-col-15 wpjb-grid-col-right">
                <a href="<?php esc_attr_e(wpjb_api_url("action/bookmark", array("object"=>"job", "object_id"=>$item->object_id, "redirect_to"=>wpjb_cypher_text($url, "wpjb_redirection_url"), "do"=>"delete"))) ?>">

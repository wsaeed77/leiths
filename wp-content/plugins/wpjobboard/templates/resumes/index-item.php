...
<div class="wpjb-grid-row wpjb-grid-flex wpjb-click-area <?php if( $resume->featured_level ): ?> wpjb-featured-resume wpjb-featured-resume-<?php echo $resume->featured_level; ?> <?php endif; ?>">
    
    <?php if($image != "none"): ?>
    <div class="wpjb-grid-col wpjb-col-logo">
        <?php if($resume->doScheme("image")): ?>
        <?php elseif($resume->getAvatarUrl()): ?>
        <div class="<?php echo apply_filters( "wpjb_tpl_list_col_img", "wpjb-flex-img wpjb-flex-img-resume", $resume ) ?>">
            <img src="<?php echo $resume->getAvatarUrl($image) ?>" alt="" class="" />
        </div>
        <?php elseif(isset($image_default_url) && $image_default_url): ?>
        <div class="<?php echo apply_filters( "wpjb_tpl_list_col_img", "wpjb-flex-img wpjb-flex-img-default", $resume ) ?>">
            <img src="<?php echo esc_attr($image_default_url) ?>" alt="" class="" />
        </div>
        <?php else: ?>
        <div class="<?php echo apply_filters( "wpjb_tpl_list_col_img", "wpjb-flex-img wpjb-flex-img-bg", $resume ) ?>">
    ...
    <div class="wpjb-grid-col wpjb-col-main wpjb-col-title">
        ...
        <div class="wpjb-line-minor">
            ...
            <?php do_action( "wpjb_tpl_index_item__resume", $resume->id ) ?>
        </div>

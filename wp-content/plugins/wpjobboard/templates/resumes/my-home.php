<div class="wpjb wpjr-page-my-home">
    ...
    <div class="wpjb-layer-inside wpjb-candidate-progress" style="padding:10px; overflow:hidden;clear:both;">
    ...
    <div class="wpjb-boxes">
        ...
        <a class="wpjb-box wpjb-layer-inside <?php echo "wpjb-box-$lname" ?>" href="<?php esc_attr_e($link["url"]) ?>">
            ...
            <span class="wpjb-box-title">
                ...
                <?php do_action("wpjb_candidate_panel_after_title", $lname, $link ) ?>
            </h4>
        </a>
        <?php endforeach; ?>
    </div>

 ...
 */
 ...
 if(!is_object($resume)) {
    echo 'No Preview for [wpjb_single_resume]';
 }
...
<div class="wpjb wpjr-page-resume">
    <?php do_action( "wpjb_tpl_single_top", $resume->id, $resume->post_id, "resume" ) ?>
    ...
    <?php if( !wpjb_conf( "cv_hide_contact_form", false ) ): ?>
    ...
    <?php do_action( "wpjb_tpl_single_end", $resume->id, $resume->post_id, "resume" ) ?>

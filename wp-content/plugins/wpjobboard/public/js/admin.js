jQuery(function($) {
    ...
    $("#form_code_link").click(function(e) {
        e.preventDefault();
        $(".form_code_box").show();
    });

    $("#form_code-cancel").click(function(e) {
        e.preventDefault();
        $("#form_code").val( $("#form_code").data('initial-value') );
        $(".form_code_box").hide();
        
    });

    $("#form_code").change( function(e) {
        var selectedText = $("#form_code option:selected").html();
        $(".form_code_used").html( selectedText );
        $(".form_code_box").hide();
    });

    $("#application_form_code_link").click(function(e) {
        e.preventDefault();
        $(".application_form_code_box").show();
    });

    $("#application_form_code-cancel").click(function(e) {
        e.preventDefault();
        $("#application_form_code").val( $("#application_form_code").data('initial-value') );
        $(".application_form_code_box").hide();
        
    });

    $("#application_form_code").change( function(e) {
        var selectedText = $("#application_form_code option:selected").html();
        $(".application_form_code_used").html( selectedText );
        $(".application_form_code_box").hide();
    });
...
jQuery(function($) {
    ...
    $(".wpjb_additional_forms").click( function(e) {
        e.preventDefault();
        $(".wpjb_additional_options_box").toggle();
    });

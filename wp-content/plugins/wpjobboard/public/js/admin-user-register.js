jQuery(document).ready(function($) {
    ...
    var user_type = $("#_user_type").change(function(e) {
        ...
        if($this.val() == "link") {
            ...
            $("#user_login").val("").closest("tr").hide();
            $("#user_password").val("").closest("tr").hide();
            $("#user_password2").val("").closest("tr").hide();
            $("#user_email").val("").closest("tr").hide();
        } else {
            $("#_user_link").val("").closest("tr").hide();

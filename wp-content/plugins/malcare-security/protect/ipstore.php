...
class MCProtectIpstore_V565 {
	...
	function __construct($storage_type = MCProtectIpstore_V565::STORAGE_TYPE_DB) {
		$this->storage_type = $storage_type;
		if ($this->storage_type == MCProtectIpstore_V565::STORAGE_TYPE_FS) {
			$this->storage = new MCProtectIpstoreFS_V565();
		} else {
			$this->storage = new MCProtectIpstoreDB_V565();
		}
	}

	public static function uninstall() {
		MCProtectIpstoreDB_V565::uninstall();
	}

	public function isLPIPBlacklisted($ip) {
		if ($this->storage_type == MCProtectIpstore_V565::STORAGE_TYPE_DB) {

...
if (!class_exists('MCProtectFWRuleEngine_V565')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V565 {
	use MCProtectFWRuleStringFunc_V565;
	use MCProtectFWRuleArrayFunc_V565;
	use MCProtectFWRuleMiscFunc_V565;
	use MCProtectFWRuleRequestFunc_V565;
	use MCProtectFWRuleWPFunc_V565;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V565::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V565 $e) {
			$this->error = $e;
		}
	}

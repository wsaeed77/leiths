<?php
/**
 * Database handler for School Lookup plugin
 */
...
class School_Lookup_Database {
    ...
    public static function get_table_name() {
        global $wpdb;
        return $wpdb->prefix . 'school_lookup';
    }
    ...
    public static function create_table() {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS $table_name (
            ...
            KEY search_fields (establishment_name, street, locality, town, county, postcode(100))
        ) $charset_collate;";

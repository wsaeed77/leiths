...
<?php $image_size = apply_filters("wpjb_singular_logo_size", "300x300", "job") ?>
            ...
            <div>
                ...
                <?php else: ?>
                    ...
                    if ($comp != "n/a" && $comp != "N/A") {
                        echo '<span class="wpjb-top-header-title">';
                        echo esc_html($comp);
                        echo '</span>';
                    }
                    ?>
                ...
                <ul class="wpjb-top-header-subtitle">
                    ...
                    <?php if ($job->company_url): ?>
                        <li class="wpjb-job-company-url">
                            ...
                            <?php $job_form = new Wpjb_Form_AddJob();
                            $url_target = null;
                            if ($job_form->hasElement("company_url")): $url_target = $job_form->getElement("company_url")->getAttr("url_target"); endif; ?>
                            <a href="<?php echo esc_attr($job->company_url) ?>"
                               target="<?php echo esc_html($url_target); ?>"
                               class="wpjb-maybe-blank"><?php echo esc_html(parse_url($job->company_url, PHP_URL_HOST)) ?></a>
                        </li>
                    <?php endif; ?>

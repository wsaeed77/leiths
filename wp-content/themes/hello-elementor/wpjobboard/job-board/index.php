...
<div class="wpjb wpjb-page-index">
                ...
                <?php foreach($form->getReordered() as $group): ?>
                    <div class="wpjb-search <?php echo esc_html("wpjb-search-group-".$group->getName()) ?>" >
                        <?php foreach($group->getReordered() as $name => $field): ?>
                            <?php $side = "wpjb-input-type-half-right"; if( $name % 2 == 0): $side = "wpjb-input-type-half-left"; endif; ?>
                            <div class="wpjb-input wpjb-input-type-half <?php echo $side; ?> <?php echo esc_attr( $field->getMeta("classes") ) ?>">
    ...
    <?php if ($search_bar == "enabled-live"): ?>
        <script type="text/javascript">
            jQuery(function ($) {
                WPJB_SEARCH_CRITERIA = <?php echo json_encode($param) ?>;
    ...
    <?php if ($show_results): ?>
        <div class="wpjb-job-list wpjb-grid ll-job-grid">
